...
\usepackage[backend=biber, style=apa, citestyle=apa, sorting=nyt]{biblatex}  % APA style sorting by name, year, title (in order)
\DeclareFieldFormat{apacase}{#1}  % To override biblatex casing, which looks ugly
